...
public class UsersTable {
    ...
    private static final String TABLE_NAME = "playtimes_users";
    ...
    public Map<String, Long> getPlaytimesByUuid(UUID uuid) {
        ...
        try (val preparedStatement = dataSource.getConnection().prepareStatement(String.format("SELECT * FROM `%s` WHERE `uniqueId` = ?", TABLE_NAME))) {
