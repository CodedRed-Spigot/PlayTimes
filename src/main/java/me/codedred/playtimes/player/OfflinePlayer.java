    ...
    private void buildMessage() {
        ...
        if (ServerUtils.hasPAPI()) {
            ...
            for (String msg : message) {
                papiMessage.add(PAPIHolders.getHolders(Bukkit.getOfflinePlayer(target), msg));
            }
            message = papiMessage;
        }
        ...
        for (String msg : message) {
            ...
            msg = msg.replace("%timesjoined%", Long.toString(statManager.getPlayerStat(target, StatisticType.LEAVE)));
